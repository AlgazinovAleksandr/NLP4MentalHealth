...
LLM #1 — Агент-интервьюер (LangGraph)
  • Задаёт до 5 уточняющих вопросов на основе ответов анкеты
...
Файл `.env.example` содержит шаблон с OpenRouter. Поддерживается любой провайдер, совместимый с OpenAI API.

### 4. Запуск FastAPI-бэкенда (терминал 1)
...
Проверка: [http://127.0.0.1:8765/docs](http://127.0.0.1:8765/docs)

### 5. Запуск Streamlit-интерфейса (терминал 2)
